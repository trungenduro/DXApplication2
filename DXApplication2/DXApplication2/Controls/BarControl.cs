...
namespace DemoCenter.Maui.Views {
    public class BarControl : ContentView {
        ...
        public static readonly BindableProperty ColorProperty = BindableProperty.Create(nameof(Color), typeof(Color), typeof(BarControl), DXColor.Red, propertyChanged: OnColorChanged);
